...
export const Footer = () => (
	<footer className="footer mt-auto py-3 text-center">
		<p>
          Made with 🍑 by
          <a 
          href="https://github.com/joserafa98" //añadir tu github
          > 
            <img
              className="logo"
              src="https://avatars.githubusercontent.com/u/170359084?v=4"  // añadir una imagen, truco usar la de tu avatar de github
              style={{
              ...
              alt="logo"
            />
            Jose Hernandez {/* aqui se vera el texto en enlace, añadir tu propio Nick  */}
          </a>{" "}
          on

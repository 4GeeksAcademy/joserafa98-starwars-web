                        ...
                        <div className="card-body">
                            ...
                            <div className="like-wrapper">
                                        <input
                                            ...
                                            checked={store.favorites.some(fav => fav.uid === character.uid)}
                                            onChange={() => actions.addCharacterFavorites(character)}
                                        />
                                        <label className="container"  id="likebutton" htmlFor={`like-toggle-${index}`}>
                                            <svg
                                                viewBox="0 0 512 512"
